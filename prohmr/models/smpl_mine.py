...
class SMPL(_SMPL):
    ...
    def __init__(self, *args, **kwargs):
        ...
        J_regressor_extra = np.load(my_config.J_REGRESSOR_EXTRA)
        J_regressor_cocoplus = np.load(my_config.COCOPLUS_REGRESSOR)
        J_regressor_h36m = np.load(my_config.H36M_REGRESSOR)
